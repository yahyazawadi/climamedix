...
To keep track of the growing application surface area, here is a definitive list of all configured application routes handled via `App.jsx` and `window.history`:
*   **`/`** - Home Page
*   **`/about`** - About Us Page
...
*   **`/join`** - Membership / Join Network Form
*   **`/news`** - News & Blog Feed
*   **`/article?id=[uuid]`** - Article Reader Page
*   **`/research`** - Research & Publications Hub
*   **`/research-upload`** - Research Document Upload Form (Admin/Author)
*   **`/courses`** - LMS Student Dashboard
*   **`/admin/courses`** - Course Builder Dashboard (Admin)
*   **`/admin/users`** - User Role Management Dashboard (Admin)
*   **`/admin/stats`** - Analytics & Statistics Dashboard (Admin)
