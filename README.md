...
*   [ ] **Advanced Quiz Submissions:** Expand quiz capabilities to allow file uploads (images, PDFs, docs) and text submissions (short/long text) that are manually graded by the quiz-maker.
---
...
For a complete map of all application pages, URL aliases, and their required permission access controls, please see **[ROUTES.md](./ROUTES.md)**.
