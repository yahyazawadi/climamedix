  ...
  const handleSave = async (e) => {
    ...
    if (inputType === 'file') {
      ...
      try {
        ...
        finalContent = `
          <div class="aep-document-embed" style="max-width: 500px; margin: 40px auto; text-align: center; padding: 40px; background: #ffffff; border-radius: 16px; border: 1px solid rgba(11,40,73,0.1); box-shadow: 0 8px 30px rgba(11, 40, 73, 0.05);">
